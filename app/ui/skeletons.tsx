        ...
        <>
            {Array(redditAmount).fill(0).map((_, i) => (
                ...
                className={`
                    ...
                    ${isDarkTheme ? "bg-dark-surface border-gray-800" : "bg-light-surface"}
                `}
                >
                    <div className="flex items-center">
                        <Skeleton circle width={50} height={50} baseColor={`${isDarkTheme ? "gray" : "#ebebeb" }`} highlightColor={`${isDarkTheme ? "light-gray" : "#f5f5f5"}`}/>
                        <Skeleton height={20} width={150} className="ml-3" baseColor={`${isDarkTheme ? "gray" : "#ebebeb" }`} highlightColor={`${isDarkTheme ? "light-gray" : "#f5f5f5"}`} />
                    </div>
                    <div className="flex flex-col justify-center ml-2">
                        <Skeleton width={35} height={15} className="" baseColor={`${isDarkTheme ? "gray" : "#ebebeb" }`} highlightColor={`${isDarkTheme ? "light-gray" : "#f5f5f5"}`} />
                    </div>
